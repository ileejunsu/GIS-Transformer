...
def run_experiment(epochs=epochs):
    ...
    parameters_log = CSVLogger('MobileViT_AID_6040_Parameter_log.csv')
...
save_test.tofile("MobileViT_AID_6040_test_labels.csv", sep=",")
save_predicted = np.array(predicted_labels)
save_predicted.tofile("MobileViT_AID_6040_predicted_labels.csv", sep=",")
...
#Save the model
tf.keras.models.save_model(model, 'MobileViT-AID60_40.h5')